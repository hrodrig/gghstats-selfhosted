...
- Optional: **`gghstats_compose_repo_version`** (default `develop`), **`gghstats_image_version`** (default `v0.7.11`), **`gghstats_port`**, **`gghstats_filter`**, **`gghstats_sync_on_startup`** (default **`false`** for faster smoke tests)
