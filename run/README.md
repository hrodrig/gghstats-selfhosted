...
| *(Optional)* **Custom dashboard CSS** | [Repository README — Custom UI theme (optional)](../README.md#custom-ui-theme-optional) — **`GGHSTATS_CUSTOM_CSS`**, image **≥ 0.2.0** (defaults use **`v1.0.0`**). |
