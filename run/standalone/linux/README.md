...
```bash
wget -q -O /tmp/gghstats.deb https://github.com/hrodrig/gghstats/releases/download/v0.10.1/gghstats_0.10.1_linux_amd64.deb
...
```bash
sudo dpkg -i ./gghstats_0.10.1_linux_amd64.deb
```
...
```bash
sudo dnf install -y "https://github.com/hrodrig/gghstats/releases/download/v0.10.1/gghstats_0.10.1_linux_amd64.rpm"
```

**Local build:**

```bash
sudo dnf install ./gghstats_0.10.1_linux_amd64.rpm
```
