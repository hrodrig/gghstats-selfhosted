...
```bash
wget -q -O /tmp/gghstats.deb https://github.com/hrodrig/gghstats/releases/download/v1.6.0/gghstats_1.6.0_linux_amd64.deb
...
```bash
sudo dnf install -y "https://github.com/hrodrig/gghstats/releases/download/v1.6.0/gghstats_1.6.0_linux_amd64.rpm"
```
